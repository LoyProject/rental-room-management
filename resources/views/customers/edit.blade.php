                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <select id="block_id" name="block_id" required autofocus
                            ...
                            @foreach($blocks as $block)
                                <option value="{{ $block->id }}" {{ (old('block_id', $customer->block_id) == $block->id) ? 'selected' : '' }}>{{ $block->name }}</option>
                            @endforeach
                        </select>
                        @error('block_id')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" type="tel" value="{{ old('phone', $customer->phone) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('phone')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input id="house_price" name="house_price" type="number" step="0.01" min="0" value="{{ old('house_price', $customer->house_price) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('house_price')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input id="wifi_price" name="wifi_price" type="number" step="0.01" min="0" value="{{ old('wifi_price', $customer->wifi_price) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('wifi_price')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input id="garbage_price" name="garbage_price" type="number" step="100" min="0" value="{{ old('garbage_price', $customer->garbage_price) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            @error('garbage_price')
                                <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input id="old_water_number" name="old_water_number" type="number" min="0" value="{{ old('old_water_number', $customer->old_water_number) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        ...
                        <div>
                            ...
                            <input id="old_electric_number" name="old_electric_number" type="number" min="0" value="{{ old('old_electric_number', $customer->old_electric_number) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
