        ...
        <form action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700">ពាក្យសម្ងាត់ (ទទេដើម្បីរក្សាភ្លាម)</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700">បញ្ជាក់ពាក្យសម្ងាត់ (ទទេដើម្បីរក្សាភ្លាម)</label>
                        <div class="relative">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 mt-4">
                ...
                <button type="submit" class="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-200">
                    កែប្រែ
                </button>
            </div>
        </form>
