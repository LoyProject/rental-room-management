...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100 flex">
            <!-- Sidebar (left) -->
            <aside class="hidden sm:flex sm:flex-col w-64 bg-white border-r shadow-sm justify-between">
                <div>
                    <div class="m-4 shrink-0 flex items-center justify-between">
                        ...
                        <button id="toggle-aside-btn" type="button" class="flex items-center gap-2 text-gray-600 hover:text-gray-900 focus:outline-none" title="Toggle sidebar">
                    ...
                    <nav x-data="{ openSite: false, openBlock: false, openCustomer: false }" class="flex-1 px-2 pb-4 space-y-1 overflow-y-auto">
                        <a href="{{ route('dashboard') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-100 {{ request()->routeIs('dashboard') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                        ...
                        <a href="{{ route('sites.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-100 {{ request()->routeIs('sites.index') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-4 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('blocks.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-100 {{ request()->routeIs('blocks.index') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-4 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('customers.index') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-100 {{ request()->routeIs('customers.index') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-4 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('profile.edit') }}" class="group flex items-center px-2 py-2 text-base font-medium rounded-md hover:bg-gray-100 {{ request()->routeIs('profile.edit') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-4 h-6 w-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-4 border-t">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="w-full flex items-center justify-center px-4 py-2 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 focus:outline-none">
                            Sign Out
                        </button>
                    </form>
                </div>
