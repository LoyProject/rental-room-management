            ...
            <form method="POST" action="{{ route('blocks.update', $block->id) }}">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input id="water_price" name="water_price" type="number" step="0.01" value="{{ old('water_price', $block->water_price) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        @error('water_price')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input id="electric_price" name="electric_price" type="number" step="0.01" value="{{ old('electric_price', $block->electric_price) }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
